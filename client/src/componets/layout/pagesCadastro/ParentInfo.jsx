            ...
            <div className="personal-info-form">
                <Grid container direction="row" spacing={3}>
                    <Grid item container direction="column" spacing={2} flex={1}>
                        ...
                        <Grid item><TextField id="cpf-resp-login" label="CPF do responsável" placeholder="Apenas números" variant="outlined" fullWidth required value={props.parente_cpf} onChange={e => props.setParente_cpf(e.target.value)} /></Grid>
                    </Grid>
